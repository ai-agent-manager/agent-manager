...
// Built at runtime so secret scanners don't flag a literal credential URI.
const credentialedLocalhost = Object.assign(new URL('http://localhost/authorize'), { username: 'user', password: 'pass' }).href;
it.each([
  ...
  ['http://localhost.example.com/authorize', false], [credentialedLocalhost, false],
